...
function Filter({ plants, filterPlants, shouldWater }) {
  ...
  return (
    <form className="plant_form" onSubmit={handleSubmit}>
      <h2>
        Find your perfect plant match to add to the fam{' '}
          ...
          <div id="difficulty" onChange={handleDifficulty}>
            ...
            <label>
              <input
                ...
                value="Medium"
                onChange={difficultyIsChecked}
                className={selectedDifficulty >= 2 ? 'selected' : 'unselected'}
              />
              <div className="icon">
                <IoIosStar size={25} />
              </div>
          ...
          <div id="fill-water" onChange={handleWater}>
            <label>
              <input
                ...
                name="water"
                value="30 days"
                onChange={waterIsChecked}
                className={selectedWater >= 1 ? 'selected' : 'unselected'}
              />
              <div className="icon">
                <IoIosWater size={25} />
              </div>
            ...
            <label>
              <input
                ...
                value="14 days"
                onChange={waterIsChecked}
                className={selectedWater >= 2 ? 'selected' : 'unselected'}
              />
              <div className="icon">
                <IoIosWater size={25} />
              </div>
            ...
            <label>
              <input
                ...
                value="7 days"
                onChange={waterIsChecked}
                className={selectedWater >= 3 ? 'selected' : 'unselected'}
              />
              <div className="icon">
                <IoIosWater size={25} />
              </div>
          ...
          <div id="lights" onChange={handleLight}>
            <label>
              <input
                ...
                name="light"
                value="Low"
                onChange={lightIsChecked}
                className={selectedLight >= 1 ? 'selected' : 'unselected'}
              />
              <div className="icon">
                <IoMdSunny size={25} />
              </div>
            ...
            <label>
              <input
                ...
                value="Medium"
                onChange={lightIsChecked}
                className={selectedLight >= 2 ? 'selected' : 'unselected'}
              />
              <div className="icon">
                <IoMdSunny size={25} />
              </div>
            ...
            <label>
              <input
                ...
                value="High"
                onChange={lightIsChecked}
                className={selectedLight >= 3 ? 'selected' : 'unselected'}
              />
              <div className="icon">
                <IoMdSunny size={25} />
              </div>
          ...
          <div id="humidity" onChange={handleHumidity}>
            <label>
              <input
                ...
                name="humidity"
                value="Low"
                onChange={humidityIsChecked}
                className={selectedHumidity >= 1 ? 'selected' : 'unselected'}
              />
              <div className="icon">
            ...
            <label>
              <input
                ...
                value="Medium"
                onChange={humidityIsChecked}
                className={selectedHumidity >= 2 ? 'selected' : 'unselected'}
              />
              <div className="icon">
                <IoIosThermometer size={25} />
              </div>
            ...
            <label>
              <input
                ...
                value="High"
                onChange={humidityIsChecked}
                className={selectedHumidity >= 3 ? 'selected' : 'unselected'}
              />
              <div className="icon">
                <IoIosThermometer size={25} />
              </div>
